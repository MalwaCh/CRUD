...
<body>
    <div class="bg-pink py-3">
        <h3 class="text-white text-center">punya ais</h3>
    </div>

    <div class="container">
        <div class="justify-content-center row mt-4">
            <div class="d-flex col-md-10 justify-content-end">
                <a href="{{route('user.create')}}" class="btn-pink btn">Add</a>
            </div>
        </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('user.edit',$user->id)}}" class="btn-pink btn">Edit</a>
